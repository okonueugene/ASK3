                    ...
                    <div class="nk-block nk-block-middle nk-auth-body wide-xs">
                        ...
                        <div class="card card-bordered">
                            <div class="card-inner card-inner-lg">
                                ...
                                <form action="{{ route('register-guard', ['token' => $token]) }}" method="POST">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input type="text" class="form-control form-control-lg" id="id_number"
                                                name="id_number" placeholder="Enter your ID number">
                                        </div>
                                        @error('id_number')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                            ...
                            <div class="row g-3">
                                <div class="col-lg-6">
                                    <div class="nk-block-content text-center text-lg-left">
                                        <p class="text-soft">&copy; {{ date('Y') }} Askari. All Rights Reserved.
                                        </p>
                                    </div>
                                </div>
                            </div>
